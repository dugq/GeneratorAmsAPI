...
//                .setProxy(httpHost)
    ...
    public static JSONObject sendPost(String url, Map<String, Object> params) throws IOException{
       return sendPost(url,params,null);
    }

    public static JSONObject sendPost(String url, Map<String, Object> params,String Cookie) throws IOException {
        HttpPost httpPost = new HttpPost(url);
