 ...
 */
public class InertElementGenerator extends
...

    {
        ...
        ingoreClumns.add("logic_deleted");

    }
    public InertElementGenerator() {
        super();
    }
...
//                }
        ...
        for (IntrospectedColumn introspectedColumn : ListUtilities.removeIdentityAndGeneratedAlwaysColumns(introspectedTable
                .getAllColumns())) {
            String clumnName = MyBatis3FormattingUtilities.getRenamedColumnNameForResultMap(introspectedColumn);
