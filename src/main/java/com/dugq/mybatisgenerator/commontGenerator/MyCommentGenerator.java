...
//            if(Objects.equals(introspectedColumn.getJdbcTypeName(),"VARCHAR")){
//                field.addJavaDocLine(" * max length = "+introspectedColumn.getLength());
//            }
//            if(!introspectedColumn.isNullable()){
//                field.addJavaDocLine(" * not null default = "+introspectedColumn.getDefaultValue());
//            }
            field.addJavaDocLine(" */");
        }
    }
