...
/**
 * Created by dugq on 2019-07-27.
 */
public class DtoGenerator extends BaseRecordGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        baseRecordType = baseRecordType.replace("Entity","Dto");
        baseRecordType = baseRecordType.replace("entity","api.dto");
        ...
        for (InnerClass innerClass : topLevelClass.getInnerClasses()){
            innerClass.addSuperInterface(fullyQualifiedJavaType);
        }
